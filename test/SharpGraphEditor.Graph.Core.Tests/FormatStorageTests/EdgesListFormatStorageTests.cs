...
{
    [TestClass]
    public class EdgesListFormatStorageTests
    {
        [TestMethod]
...
3 1" + Environment.NewLine;
            ...
            var e1 = Mock.Of<IEdge>(e => e.Source == v1 && e.Target == v2);
            var e2 = Mock.Of<IEdge>(e => e.Source == v1 && e.Target == v3);
            var e3 = Mock.Of<IEdge>(e => e.Source == v2 && e.Target == v4);
            var e4 = Mock.Of<IEdge>(e => e.Source == v2 && e.Target == v3);
            var e5 = Mock.Of<IEdge>(e => e.Source == v3 && e.Target == v1);

            graphMock.Setup(g => g.Edges).Returns(new IEdge[] { e1, e2, e3, e4, e5 });
